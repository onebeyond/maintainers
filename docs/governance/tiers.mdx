...
- [ ] Create a valid CONTRIBUTING.md
- [ ] Create a valid CODE_OF_CONDUCT.md or reuse/link to the org one
- [ ] Create a valid LICENSE or reuse/link to the org one
- [ ] Build a clear roadmap and keep it up to date
- [ ] Ensure that the project is correctly setup in github (labels, milestones, projects, permissions, branch protections, etc...)
...
- [ ] Create a valid CHANGELOG.md and keep it up to date
...
- [ ] Add automations for issues/PRs and templates
- [ ] Keep your dependencies up to date with Dependabot (or similar)
- [ ] Ensure that the project publishing the package via CI and not from your local devices
...
The consolidated projects that our community relays on but do not require any active development in terms of business logic.
