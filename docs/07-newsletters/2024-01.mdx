...
- [GitHub project status updates & issues side panel](https://github.blog/changelog/2024-01-18-github-issues-projects-project-status-updates-issues-side-panel/)

**👀 Repo of the month**

JWT UI - A Terminal UI for decoding/encoding JSON Web Tokens. Give it a try [here](https://github.com/jwt-rs/jwt-ui)

![live demo](https://github.com/jwt-rs/jwt-ui/raw/main/screenshots/decoder.png)

## 🧑‍💻 Diversity in Tech

- Take a look at [this video](https://youtu.be/MmHqthzJER4?feature=shared) to learn more about the importance of Coding Accessibility.
